class Budget < ApplicationRecord
  ...
  monetize :budgeted_spending, :expected_income, :allocated_spending,
           ...
           :total_rolled_over, :remaining_with_rollover
  ...
  # available_to_allocate stays a pure "what did I plan this month"; this adds
  # what already carried in from previous periods, so the reader sees the true
  # remaining room in the plan without total_rolled_over silently vanishing.
  def remaining_with_rollover
    available_to_allocate + total_rolled_over
  end
